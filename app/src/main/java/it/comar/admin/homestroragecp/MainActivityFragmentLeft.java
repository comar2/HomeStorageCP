...
public class MainActivityFragmentLeft extends Fragment {
    ...
    public MainActivityFragmentLeft() {
    }

    public static MainActivityFragmentLeft newInstance(String param1) {
        MainActivityFragmentLeft fragment = new MainActivityFragmentLeft();
